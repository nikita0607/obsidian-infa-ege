...
Итак, задача:
![](Pasted%20image%2020230302002924.png)
Для начало, расставим заданные буквы в алфивитном порядке и присвоим им номера, начиная с нуля
А-0, П-1, Р-2, С-3, У-4
...
Задача на прямое использавние комбинаторики
...
Так может решаться ручками и программно
